...
return query_string;}();$(document).ready(function(){if(QueryString.aff!=undefined){var aff=QueryString.aff;(function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)})(window,document,'script','../../www.google-analytics.com/analytics.js','ga');ga('create',aff,'auto');ga('create','UA-60210331-1','auto',{'name':'newTracker'});ga('send','pageview');ga('newTracker.send','pageview');}});if(typeof jQuery==='undefined'){throw new Error('Bootstrap\'s JavaScript requires jQuery')}
